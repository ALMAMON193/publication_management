...
<head>
    ...
    <title>Membership Expiration Notification</title>
</head>
<body>
    <div class="email-container">
        <!-- Header -->
        <div class="email-header">Membership Expiration Notification</div>
        <!-- Body -->
        <div class="email-body">
            <p>Hello {{ $membership->user->name }},</p>
            <p>Your membership <strong>{{ $membership->membership->name }}</strong> is about to expire in
                <strong>{{ $today->diffInDays($membership->end_date) }} days</strong>.</p>
