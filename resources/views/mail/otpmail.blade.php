<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
    <div style="margin:50px auto;width:70%;padding:20px 0">
        ...
        <p style="font-size:1.1em">Thank you for choosing {{ config('app.name') }}. Please use the following One Time
            Password (OTP) to complete your Sign-Up procedures. OTP is valid for 1 hour.</p>
        <h2
