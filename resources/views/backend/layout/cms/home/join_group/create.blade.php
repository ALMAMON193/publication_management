...
@section('title', 'Create How To Join Group Lists')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create How To Join Group List</h4>
                        <form id="my-form" class="forms-sample"
                            action="{{ route('admin.cms.home.how.join.group.store') }}" method="POST"
