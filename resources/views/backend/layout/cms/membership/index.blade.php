...
@section('title', 'Membership Content List')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Membership Content List</h4>
                        <div style="display: flex;justify-content: end;">
                            <a href="{{ route('admin.cms.membership.create') }}" class="btn btn-primary">Add Item</a>
                        </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.cms.membership.index') }}",
                        type: "get",
                    },
        ...
        const deleteAuction = (id) => {
            try {
                let url = '{{ route('admin.cms.membership.destroy', ':id') }}';
