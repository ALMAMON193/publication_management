...
@section('title', 'Update Key Document Banner Content')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Update key document banner content</h4>
                        <form id="my-form" class="forms-sample"
                            action="{{ route('admin.cms.key.document.banner.update') }}" method="POST"
