...
@section('title', 'Donation History List')
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.donation-history.index') }}",
                        type: "get",
                    },
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                return data ? data : 'Anonymous Person';
                            }
                        },
                        {
                            data: 'amount',
        ...
        const deleteAuction = (id) => {
            try {
                let url = '{{ route('admin.donation-hiostory.delete', ':id') }}';
