...
@section('title', 'Edit Key Documents')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Key Documents</h4>
                        <form action="{{ route('admin.key.document.update', $keyDocument->id) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div id="pdf-preview" style="margin-top: 10px;">
                                    @if ($keyDocument->document)
                                        <embed src="{{ asset($keyDocument->document) }}" width="100%" height="500px" />
                                    @endif
                                </div>
                            </div>
