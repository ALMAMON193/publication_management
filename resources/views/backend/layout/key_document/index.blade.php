...
@section('title', 'Key Document List')
                ...
                <div class="card">
                    <div class="card-body">
                        <div style="display: flex;justify-content: space-between;align-items: center;">
                            <h4 class="card-title">Key Document List</h4>
                            <a href="{{ route('admin.key.document.create') }}" class="btn btn-primary">Add document</a>
                        </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.key.document.index') }}",
                        type: "get",
                    },
        ...
        const deleteAuction = (id) => {
            try {
                let url = '{{ route('admin.key.document.destroy', ':id') }}';
