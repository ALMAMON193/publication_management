...
@section('title', 'Core publication List')
                ...
                <div class="card">
                    <div class="card-body">
                        <div style="display: flex;justify-content: space-between;align-items: center;">
                            <h4 class="card-title">Core publication List</h4>
                            <a href="{{ route('admin.core_publication.create') }}" class="btn btn-primary">Add publication</a>
                        </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.core_publication.index') }}",
                        type: "get",
                    },
        ...
        const deleteAuction = (id) => {
            try {
                let url = '{{ route('admin.core_publication.destroy', ':id') }}';
