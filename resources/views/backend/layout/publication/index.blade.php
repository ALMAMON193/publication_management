                ...
                <div class="card">
                    <div class="card-body">
                        <div style="display: flex;justify-content: space-between;align-items: center;">
                            <h4 class="card-title">Publication List</h4>
                            <a href="{{ route('admin.publication.create') }}" class="btn btn-primary">Add publication</a>
                        </div>
...
@push('script')
    ...
    <script>
        ...
        const deleteAuction = (id) => {
            try {
                let url = '{{ route('admin.publication.destroy', ':id') }}';
