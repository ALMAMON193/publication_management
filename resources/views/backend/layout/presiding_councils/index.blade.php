...
@section('title', 'Presiding Councils List')
                ...
                <div class="card">
                    <div class="card-body">
                        <div style="display: flex;justify-content: space-between;align-items: center;">
                            <h4 class="card-title">Presiding Councils List</h4>
                            <a href="{{ route('admin.presiding_councils.create') }}" class="btn btn-primary">Add
                                Presiding</a>
                        </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.presiding_councils.index') }}",
                        type: "get",
                    },
                    columns: [{
                            data: 'DT_RowIndex',
        ...
        const deleteAuction = (id) => {
            try {
                let url = '{{ route('admin.presiding_councils.destroy', ':id') }}';
