...
@section('title', 'Preceding Council')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Create Preceding Council</h4>
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="{{ route('admin.presiding_councils.store') }}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('bio') is-invalid @enderror" name="bio" id="content">{{ old('bio') }}</textarea>
                                        @error('bio')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('designation_type') is-invalid @enderror"
                                            ...
                                            <option value="Councilman"
                                                {{ old('designation_type') == 'Councilman' ? 'selected' : '' }}>
                                                Councilman
                                            </option>
                                            <option value="Vice Chairperson"
                                                {{ old('designation_type') == 'Vice Chairperson' ? 'selected' : '' }}>
                                                Vice Chairperson
                                            </option>
                                            <option value="Chairman"
                                                {{ old('designation_type') == 'Chairman' ? 'selected' : '' }}>
                                                Chairman
                                            </option>
                                        </select>
